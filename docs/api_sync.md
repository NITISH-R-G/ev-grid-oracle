...
## Module: `/app/viz/record_two_phase.py`
*(No module docstring)*
...
## Module: `/app/viz/__init__.py`
*(No module docstring)*

---

## Module: `/app/viz/record.py`
*(No module docstring)*
...
## Module: `/app/server/ev_grid_environment.py`
*(No module docstring)*
...
## Module: `/app/server/ev_grid_road_environment.py`
*(No module docstring)*
...
## Module: `/app/server/role_metrics.py`
*(No module docstring)*
...
## Module: `/app/server/__init__.py`
Server package for OpenEnv runtime.

---

## Module: `/app/server/road_router.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/bescom_feed.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/road_models.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/road_env.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/multi_agent.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/city_graph.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/reward.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/reward_hack.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/__init__.py`
EV Grid Oracle package.

---

## Module: `/app/ev_grid_oracle/personas.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/world_model_verifier.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/grid_sim.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/models.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/scenarios.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/env.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/parsing.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/oracle_agent.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/demand_sim.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/policies.py`
*(No module docstring)*
...
## Module: `/app/ev_grid_oracle/traffic.py`
*(No module docstring)*
...
## Module: `/app/tools/build_road_graph.py`
*(No module docstring)*
...
## Module: `/app/tools/sync_space_to_hub.py`
...
## Module: `/app/tools/generate_knowledge_graph.py`
*(No module docstring)*
...
## Module: `/app/tools/fetch_bangalore_roads_overpass.py`
*(No module docstring)*
...
## Module: `/app/tools/export_grpo_tensorboard_plots.py`
...
## Module: `/app/tools/prune_osm_geojson.py`
*(No module docstring)*
...
## Module: `/app/tools/__init__.py`
*(No module docstring)*

---

## Module: `/app/tools/docs_sync.py`
*(No module docstring)*
...
## Module: `/app/tools/road_reward_smoke.py`
*(No module docstring)*
...
## Module: `/app/tools/generate_health_dashboard.py`
*(No module docstring)*
...
## Module: `/app/tools/write_eval_snapshot.py`
...
## Module: `/app/tools/fetch_osm_roads.py`
*(No module docstring)*
...
## Module: `/app/tools/build_roads_render.py`
*(No module docstring)*
...
## Module: `/app/training/fair_eval.py`
*(No module docstring)*
...
## Module: `/app/training/__init__.py`
Training scripts (not imported by server/runtime).

---

## Module: `/app/training/make_plots.py`
*(No module docstring)*
...
## Module: `/app/training/evaluate.py`
*(No module docstring)*
