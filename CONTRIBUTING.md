...
Make sure your changes don't break the existing test suite.
...
At this point, you should switch back to your master branch and make sure it's up to date with this repository's master branch.
