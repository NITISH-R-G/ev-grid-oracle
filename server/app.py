...
def _demo_oracle_act_with_guard(
    *,
    ...
    Returns: action, oracle_text, oracle_llm_active, oracle____timed_out, oracle____skipped_env
    """
...
def ma_auto_step(
    ...
    if payload.fleet_policy == "baseline":
        ...
        action, _txt, active, ___timed_out, ___skipped = _demo_oracle_act_with_guard(
...
def demo_spawn_vehicle(
    ...
    dst = _BY_ID.get(assigned_station_id) if assigned_station_id else None
...
def demo_step(
    ...
    try:
        ...
        oracle_text = ""
        oracle____timed_out = False
        oracle____skipped_env = False
        dream_score = None
        ...
        out = {
            ...
            "oracle____timed_out": oracle____timed_out,
            "oracle____skipped_env": oracle____skipped_env,
        ...
        log.info(
            ...
            extra={
                ...
                "oracle_timeout": bool(oracle____timed_out),
                "oracle____skipped": bool(oracle____skipped_env),
